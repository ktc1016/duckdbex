defmodule Duckdbex.MixProject do
  ...
  def project do
    [
      ...
      make_precompiler_url:
        "https://github.com/ktc1016/duckdbex/releases/download/v#{@version}/@{artefact_filename}",
      ...
      # Docs
      name: "Duckdbex",
      source_url: "https://github.com/ktc1016/duckdbex/",
      homepage_url: "https://github.com/ktc1016/duckdbex/",
      docs: docs()
    ]
  end
  ...
  defp package do
    [
      ...
      licenses: ["MIT"],
      links: %{
        "GitHub" => "https://github.com/ktc1016/duckdbex",
        "Changelog" => "https://github.com/ktc1016/duckdbex/blob/main/CHANGELOG.md"
      }
    ]
  end
